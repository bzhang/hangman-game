function fetchWords(callback) {
    ...
    // use proxy to workaround CORS issue, works in Chrome without additional configuration
    // if run in Safari, select the "Disable Cross-Origin Restrictions" option in Develop menu
